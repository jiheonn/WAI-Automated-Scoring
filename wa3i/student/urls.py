...
urlpatterns = [
    ...
    path('Homework/Homeworkselect/Homeworklist/', views.Homeworklist, name='Homeworklist'),
    path('Homework/Homeworkselect/Homeworklist/Homeworkcheck/', views.Homeworkcheck, name='Homeworkcheck'),
